...
# model_path = "./checkpoints/CKPT_3D_AIST/aist_final_lstm_o10_i10_m12_rnn1_s5_os2frames_ckpte9_v0.810_t0.275_m0.000"
model_path = "./checkpoints/CKPT_3D_AIST/aist_final_lstm_o100_i20_m12_rnn1_s9_os4frames_ckpte9_v0.749_t0.401_m0.000"
# model_path = "./checkpoints/CKPT_3D_AIST/aist_final_music_o20_i30_m12_rnn2_s5_os5frames_ckpte14_v0.805_t0.298_m0.000"
start_frame = 16
...
def update_graph(num):
    ...
    if num < args.input_n:
        ...
        graph.set(color = 'y')
    title.set_text('Auto-regressive with LSTMs {}, time={}'.format(vid_name, num))
...
f = r"../data/animation_rnn_o"+str(args.output_n)+"_i"+str(args.input_n)+"_"+vid_name+".gif"
