...
# model_path = "./checkpoints/CKPT_3D_AIST/aist_final_3d_o20_i30_cnn4frames_ckpte24_v0.248_t0.285"
model_path = "./checkpoints/CKPT_3D_AIST/aist_final_3d_o20_i30_cnn4frames_ckpte9_v0.248_t0.286"
start_frame = 0
...
f = r"../data/animation_3D_o"+str(args.output_n)+"_i"+str(args.input_n)+"_"+vid_name+".gif"
