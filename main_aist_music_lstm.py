...
model_name='aist_lstm_o'+str(args.output_n)+'_i'+str(args.input_n)+'_m'+str(args.music_as_joint)+'_rnn'+str(args.n_tcnn_layers)+'_s'+str(args.step_size)+'_os'+str(args.output_step_size)+'frames_ckpt'
